...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-panel">
	...
	<button name="copyrightStep" id="step1">Step 1</button><br>
	<button name="copyrightStep" id="step2">Step 2</button><br>
	<button name="copyrightStep" id="step3">Step 3</button><br>
	<button name="copyrightStep" id="step4">Step 4</button><br>
	<button name="copyrightStep" id="step5">Step 5</button><br>
	<button name="copyrightStep" id="step6">Step 6</button><br>
	</form>
