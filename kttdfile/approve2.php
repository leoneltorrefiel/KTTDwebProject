<?php
	...
	if(isset($_GET['approve'])){
			...
			$sql = "SELECT pending_tech_name,pending_tech_description,pending_tech_owner,pending_tech_username,pending_tech_acct,p_tech_filename,p_tech_filetype,p_tech_filepath,datetime from pending_tech where pending_tech_id='$id'";
			...
			$sql2 = "INSERT into technologies(tech_name,tech_description,tech_owner,tech_username,tech_acct,tech_filename,tech_filetype,tech_filepath,date_approved,date_request) values('$pending_tech_name','$pending_tech_description','$pending_tech_owner','$pending_tech_username','$pending_tech_acct','$p_tech_filename','$p_tech_filetype','$p_tech_filepath',NOW(),'$datetime')";
