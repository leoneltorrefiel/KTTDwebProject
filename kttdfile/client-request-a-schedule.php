...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
 ...
 <div class="w3-bar-block">
    ...
    <a href="./client-request-a-schedule.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="far fa-clock fa-fw"></i>  Request A Schedule</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <form action="client-request-a-schedule.php" method="post">
  <div class="w3-panel">
