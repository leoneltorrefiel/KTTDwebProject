<?php
	...
	$tmp = $_SESSION['username'];
  	...
  	$sql = "SELECT * from peding_request where username='$tmp' order by reqDate ASC";
  	$res_1 = mysqli_query($db,$sql);

  	$sql1 = "SELECT * from approvedreq where username='$tmp'";
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="./client-request-date.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-plus-circle fa-fw"></i>  My Request Date</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i> My Request Schedule </b></h5>
  </header>
          ...
          <tr>
            ...
            <td><strong><i>Status</i></strong></td>
                    ...
                    <?php
                            ...
                            echo "<tr>"; 
                            echo "<td>".$pending1['reqdate']."</td>";
                            echo "<td>"."<font color='green' size='5'><i class='fa fa-thumbs-up fa-fw'></i></font>"."</td>";
                            echo "</tr>";
                            }

                            while($pending=mysqli_fetch_assoc($res_1)){
                              echo "<tr>";
                            echo "<td>".$pending['reqDate']."</td>";
                            echo "<td>"."Waiting..."."</td>"; 
                            echo "</tr>";
                            }
                    ?>
