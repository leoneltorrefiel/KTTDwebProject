<?php
	...
	while($row=mysqli_fetch_assoc($result)){
		...
		echo "<td class='cell100 column7-aaa'>"; echo "<a href='updateAccount.php?update={$row['account_id']}'><submit><font color='green' size='5'><i class='fa fa-edit'></i></font></submit></a>"."</td>";
		echo "</tr>";
	}
	echo "</table>";
