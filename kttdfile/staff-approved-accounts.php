...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="./staff-approved-accounts.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-user-alt fa-fw"></i> Approved Accounts</a>
                                    ...
                                    <?php
                                        if(empty($nm)){
                                            ...
                                            while($pending=mysqli_fetch_assoc($view1)) {
                                              echo "<td>".$tableNum."</td>";
                                                echo "<td class='cell100 column6-aaa'>"."<center><img  height='50' width='50' src='".$pending['file_path']."'></center>"."</td>";
