          ...
          <div class="table100-body js-pscroll">
            <table>
              <tbody>
                            ...
                            echo "<td class='cell100 column6-aat'><center>"."<a href='view-staff-tech.php?check={$pending1['tech_id']}'><font color='#8ec735'><i class='fa fa-eye fa-fw'></i></font></a>"."</center></td>";
                            echo "<tr>"; 
                            }
