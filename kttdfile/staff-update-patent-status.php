...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container w3-row">
    ...
    <div class="w3-col s8 w3-bar">
      ...
      <form action="staff-update-patent-status.php" method="post">
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <p>Tecnology: <b><font color="green"><?php echo $_SESSION['patentName']; ?></font> Status</b></p>
  </header>
  <div class="w3-panel">
      ...
      <div class="w3-third">
         <center>
            <form action="" method="post">
                ...
                <div class="popup">
                <button id="b1"  class="btnCheck" name="patentStepForward2"><font color="#108f01" size="10"><i class="far fa-plus-square fa-fw"></i></font></button>
